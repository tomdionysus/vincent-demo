...
func (me *Config) Validate() []error {
  ...
  if *me.LogLevel == "" { out = append(out, errors.New("-loglevel or ENV LOG_LEVEL must be specified")) }
  if me.HTTPPort == nil { out = append(out, errors.New("-port or ENV PORT must be specified")) }
